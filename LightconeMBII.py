...
# Save the light cone to a file
np.save(DATA_DIRECTORY + 'Lightcone.npy', Lightcone)
...
# Create the colorbar
cbar = fig.colorbar(cax, ticks=[1, 2, 3], pad=0.01)
...
plt.savefig(PLOT_DIRECTORY + 'Lightcone2d.pdf', dpi=300)
