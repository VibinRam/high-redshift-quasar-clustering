...
completeness_map = np.load(args.completeness_map_file)
...
bh_coordinates = np.load('bh_coordinates_lightcone.npy')
...
df.to_csv(args.output_csv_file_comp, index=False)
...
#Save the data to a file
df.to_csv(args.output_csv_file_incomp, index=False)